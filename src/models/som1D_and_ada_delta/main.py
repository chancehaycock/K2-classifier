...
model_name = "som1D_and_ada" 
training_set = 'delta'

# =========================================
#      SOM1D AND ADA (K2SC_DELTA) MODEL
# =========================================

def SOM1D_and_ADA_delta():

	model_number = sys.argv[1]

	print_model_type("SOM1D and ADA")
...
#	evaluate_model(model_name, training_set, model_number, blank_classifier, df, parameters, num_parameters, features, in_cv=5, out_cv=5)
	...
	classifier = ADA(random_state=2, n_estimators=100)
